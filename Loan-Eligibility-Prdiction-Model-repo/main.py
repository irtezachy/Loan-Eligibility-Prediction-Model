...
df = load_data("Loan-Eligibility-Prdiction-Model-repo\\data\\raw\\credit.csv")
#cleaning the data
...
with open('Loan-Eligibility-Prdiction-Model-repo\\models\\logistic_regression.pkl', 'wb') as f:
...
# Save the trained model
with open('Loan-Eligibility-Prdiction-Model-repo\\models\\decision_tree_classifier.pkl', 'wb') as f:
...
# Save the trained model
with open('Loan-Eligibility-Prdiction-Model-repo\\models\\random_forest_classifier.pkl', 'wb') as f:
...
with open("Loan-Eligibility-Prdiction-Model-repo\\models\\" + best_logistic_regression_model_filename, 'wb') as file:
...
with open("Loan-Eligibility-Prdiction-Model-repo\\" + best_decision_tree_classifier_filename, 'wb') as file:
...
with open("Loan-Eligibility-Prdiction-Model-repo\\models\\" + best_random_forest_classifier_filename, 'wb') as file:
