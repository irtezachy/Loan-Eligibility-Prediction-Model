...
def clean_dataset(dataset):
    ...
    LoanStatus_barchart(dataset, 'Loan-Eligibility-Prdiction-Model-repo\\reports\\figures\\loan_status_barcharts.png')
    ...
    LoanAmount_displot(dataset, 'Loan-Eligibility-Prdiction-Model-repo\\reports\\figures\\LoanAmount_displots.png')
    ...
    dataset.to_csv("Loan-Eligibility-Prdiction-Model-repo\\data\\processed\\processed_credit.csv",index=None)
